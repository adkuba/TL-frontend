<template lang="html">
    <div id="statistics">
        ...
        <div class="element" v-if="user">
            ...
            <p class="timeline-id">{{ user.username }}</p>
            <div class="info-container">
                ...
                <div class="profile-item">
                    You are following 
                    <div class="profile-data">{{ user.followers.length - user.followers.filter(e => e.userId != null).length }} users </div>
                </div>
                <div class="profile-item">
                    Your likes
        ...
        <div class="element" v-for="(timeline, idx) in timelines" :key="idx">
            ...
            <p class="timeline-id">{{ timeline.id }}</p>
            <div class="left">
                ...
                <div class="daneh">
                    Premium views
                    <div class="desc">Number of views generated by premium section</div>
                </div>
